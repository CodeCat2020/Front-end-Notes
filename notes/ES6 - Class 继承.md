...
4. [类的 prototype 属性和 `__proto__` 属性](https://es6.ruanyifeng.com/#docs/class-extends#类的 prototype 属性和__proto__属性)
...
下面代码中，子类 `B` 的构造函数之中的 `super()`，代表调用父类的构造函数。这是必须的，否则 JavaScript 引擎会报错。
